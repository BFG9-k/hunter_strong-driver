...
namespace drv_related
{
	...
	NTSTATUS drv_main(PDRIVER_OBJECT drv_obj, PUNICODE_STRING reg_path)
	{
		...
		drv_related::g_utls.dbg_print("++=> driver initialized\n"); //"++=> driver initialized\n" drv_extension::strings::km_s_005
